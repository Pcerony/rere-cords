...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18nDict = {
        ...
        "poster-card-text": {
            "zh": "通常在校园内张贴的实体海报背面均附有一张废旧黑胶唱片。如果海报背面的唱片已被取完，请寻找校园内的其他海报，或直接通过电子邮件联系我们申请补充材料。",
            "ja": "学内に掲示されている実物ポスターの裏面には、制作素材としてのアナログレコードが添付されています。もし裏面のレコードがすでに回収されている場合は、他所に掲示されたポスターを探すか、または事務局メールアドレスまで直接ご連絡の上、追加配布を申請してください。"
        },
        "title-timeline": {
            "zh": "日程进程",
            "ja": "プロジェクトスケジュール"
